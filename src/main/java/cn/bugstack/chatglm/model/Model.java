...
public enum Model {
    ...
    @Deprecated
    COGVIEW_3_Plus("cogview-3-plus", "根据用户的文字描述生成图像,使用同步调用方式请求接口"),
    COGVIEW_3_Flash("cogview-3-flash", "根据用户的文字描述生成图像,使用同步调用方式请求接口"),
    COGVIEW_4("cogview-4", "根据用户的文字描述生成图像,使用同步调用方式请求接口"),
    COGVIDEOX_Flash("cogvideox-flash", "CogVideox-Flash是智谱 AI 推出的免费的视频生成模型，该模型具备强大的视频生成能力。"),
    @Deprecated
    COGVIDEOX("cogvideox", "CogVideox是智谱 AI 推出的视频生成模型，该模型具备强大的视频生成能力。"),
    COGVIDEOX_2("cogvideox-2", "CogVideox-2是智谱 AI 推出的视频生成模型，该模型具备强大的视频生成能力。"),
    ;
